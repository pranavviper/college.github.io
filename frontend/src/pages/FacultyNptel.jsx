...
const FacultyNptel = () => {
    ...
    const fetchAchievements = async () => {
        try {
            ...
            // Filter only 'Online Course'
            const filtered = data.filter(item => item.type === 'Online Course');
    ...
    return (
        <div className="max-w-6xl mx-auto py-8">
            <div className="flex justify-between items-center mb-6">
                <div>
                    <h1 className="text-3xl font-bold mb-2 text-primary">NPTEL Courses Approval</h1>
                    <p className="text-slate-500">Manage student online course achievements.</p>
                </div>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-slate-200 overflow-hidden">
                {loading ? (
                    ...
                    <p className="p-8 text-center text-slate-500">No NPTEL courses found.</p>
                ) : (
                        ...
                        <table className="w-full text-left border-collapse">
                            <thead className="bg-slate-50 border-b border-slate-200">
                                <tr>
                                    ...
                                    <th className="p-4 font-semibold text-slate-600 text-sm uppercase tracking-wider">Description</th>
